  ...
  const changeCount=()=>{
            ...
            <nav className="relative "  >
                <div className="   flex w-svw z-40 bg-white  fixed flex-row  justify-between xl:px-[150px] items-center py-2 px-[30px]">
                    <div>
                        <Link href={"/"}>
                        <div>
            <span className='flex font-serif text-xs md:text-lg items-center font-[600]'>smart<span className='px-2'>
              <svg xmlns="http://www.w3.org/2000/svg" width="35" height="26" viewBox="0 0 38 31" fill="none">
          ...
          <div className="absolute top-[0px] left-[252px] leading-[24px] font-semibold inline-block min-w-[49px] z-[1]">
            blogs
                    ...
                    <div className="flex flex-row gap-5 lg:mr-[170px] mr-[33px] ">
                      <div className="lg:flex hidden flex-row items-center gap-2 border-2 mx-2 text-xs text-purple-700 font-[600] uppercase border-purple-500 rounded-xl bg-transparent px-5 py-2 mq1350:hidden">
                      <div class="relative left-[45px] inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
            <svg class="w-4 h-4 text-purple-500 dark:text-purple-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
            </svg>
        </div>
      <input className='lg:flex hidden flex-row items-center gap-2 border-2 mx-2 text-xs text-purple-700 font-[600] uppercase border-purple-500 rounded-xl bg-transparent     px-5 py-2' />
    </div> 
    ...
    onClick={onOpen}  >Login</button>
            ...
            {toggle && (
                    ...
                    <div className="fixed bg-white w-screen top-[100px] z-10 h-screen ">
                        <div className="block lg:hidden">
                        <div className="self-stretch h-[11px] relative grid grid-flow-row top-10 gap-2 left-10">
          <div className="  leading-[24px] font-semibold inline-block min-w-[48px] z-[1]">
            home
          </div>
          <div className=" leading-[24px] font-semibold inline-block min-w-[69px] z-[1]">
            courses
          </div>
          <div className=" leading-[24px] font-semibold inline-block min-w-[42px] z-[1]">
            shop
          </div>
          <div className="  leading-[24px] font-semibold inline-block min-w-[49px] z-[1]">
            blogs
          </div>
        </div>
                        </div>

                        <div className="flex-col block my-2 mt-[170px] ml-8 lg:hidden">
                        <div className="lg:hidden flex flex-row items-center border-2 text-xs text-purple-700 font-[600] uppercase border-purple-500 rounded-xl bg-transparent mq450:w-10   ">
                      <div class="relative left-[10px] inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
            <svg class="w-4 h-4 text-purple-500 dark:text-purple-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
            </svg>
        </div>
      <input className='flex lg:hidden flex-row items-center gap-2 border-2 -mx-4 text-xs text-purple-700 font-[600] uppercase border-purple-500 rounded-xl bg-transparent     px-5 py-2 mq450:w-10' />
                        </div> 
