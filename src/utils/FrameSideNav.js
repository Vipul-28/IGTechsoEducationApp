...
// alert(isSidebarOpen)
  return (
    <div>
      ...
      {/* Sidebar */}
      <div
        className={`inset-y-0 z-1000 flex w-[100px] ${
          isSidebarOpen ? 'translate-x-full' : '-translate-x-full'
      ...
      >
        ...
        <div className="z-10 flex flex-col flex-1">
          ...
          <nav className="flex flex-col flex-1 w-64 p-4 mt-4 ">
            <a href="#" className="flex items-center space-x-2 w-[250px] h-[40px] rounded-xl text-black ">
              <svg
                className="w-6 h-6 "
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
